...
<template>
  <div class="pagination-container">
    ...
    <Modal
      v-model="modal"
      :title="$t('Main.UnitManagement.propertyAdmins.add')"
      ...
      <div class="edit-panel">
        <Form :rules="ruleInline" ref="formInline" :model="formInline">
          <FormItem prop="propertyBelonged">
            <label for="propertyBelonged">{{$t('Main.UnitManagement.propertyAdmins.belong')}}:</label>
            <Select
              size="large"
          ...
          <FormItem prop="repassword">
            <label for="repassword">{{$t('Common.confirmPsw')}}:</label>
            <Input
              ...
              clearable
              :maxlength="50"
              :placeholder="$t('Main.UnitManagement.hint.plzConfirmPsw')"
              style="width: 100%"
            />
          </FormItem>
          <FormItem>
    ...
    <Modal
      ...
      :title="$t('Main.UnitManagement.propertyAdmins.edit')"
      :mask-closable="closable"
      footer-hide
    >
      <div class="edit-panel">
    ...
    return {
      ...
      ruleInline: {
        ...
        repassword: [
          {
            required: true,
            message: this.$t("Main.UnitManagement.hint.plzConfirmPsw"),
            trigger: "blur"
          }
        ]
      },
